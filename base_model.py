...
from models import TransDModule, TransEModule, TransHModule, DistMultModule, ComplExModule, SimplEModule, TuckerModule
...
class BaseModel(object):
    def __init__(self, n_ent, n_rel, args):
        if args.model == 'TransE':
            ...
            self.model = TuckerModule(n_ent, n_rel, args)
        else:
