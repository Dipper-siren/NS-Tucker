...
parser.add_argument('--task_dir', type=str, default='KG_Data/FB15K-237', help='the directory to dataset')
parser.add_argument('--model', type=str, default='Tucker',  help='scoring function, support [TransE, TransD, TransH, DistMult, ComplEx, SimplE]')
parser.add_argument('--sample', type=str, default='IS', help='sampling method from the cache')
...
parser.add_argument('--hidden_dim', type=int, default=200, help='set embedding dimension')
...
parser.add_argument('--n_batch', type=int, default=128, help='number of batch size')
